...
console.log(Number.isNaN(Number.parseInt('10px')));
console.log(Number.parseInt('1a2'));
console.log(Number.parseInt('a10'));
...
console.log(Math.max(2, 4, '5', 1));
console.log(Math.max(2, 4, '5p', 1));

/// calculate area
console.log(Math.PI * Number.parseFloat('10px') ** 2);

/// create random between 1 - 6
console.log(1 + Math.trunc(Math.random() * 6));

const randomInt = (min, max) =>
  min + Math.trunc(Math.random() * (max - min + 1));

const myRandomArr = Array.from({ length: 7 }, (_, k) => randomInt(2, 7));
...
/// rounding decimals
console.log((1.57).toFixed(0));
console.log((1.57).toFixed(1));
/// to convert the result to number again
console.log(+(1.57).toFixed(1));
